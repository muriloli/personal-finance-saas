...
const translations = {
  "pt-BR": {
    ...
    startAddingExpenses: "Comece adicionando suas primeiras despesas para ver o gráfico por categoria",
  ...
  "en": {
    ...
    startAddingExpenses: "Start adding your first expenses to see the category breakdown chart",
  ...
  "es": {
    ...
    startAddingExpenses: "Comienza agregando tus primeros gastos para ver el gráfico por categoría",
